        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="longitud.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>
                      Longitud
                  </p>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Longitud</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Registro de Longitudes de Tallos
                </h3>
            ...
            <div class="card card-primary">
              ...
              <form>
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label for="exampleInputText3">Longitud</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Medida">
                  </div>
                  <div class="form-group">
