        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="calidad.jsp" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Calidad</p>
                </a>
              </li>
              ...
              <li class="nav-item">
                <a href="tallos.jsp" class="nav-link active">
                  <i class="far fa-circle nav-icon"></i>
                  <p>N° Tallos</p>
                </a>
              </li>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">N° Tallos</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
            ...
            <div class="card">
              <div class="card-header">
                <h3 class="card-title">
                  ...
                  Registro de Cantidad de Tallos por Bonche
                </h3>
              ...
              <form>
                <div class="card-body">
                  <div class="form-group">
                    <label for="exampleInputText">Numero de Tallos</label>
                    <input type="email" class="form-control" id="exampleInputEmail1" placeholder="Tallos">
                  </div>
                  <div class="form-group">
                    <label for="exampleInputText2">Valor</label>
                    <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Valor">
                  </div>
                    <div class="form-group">
                    <label for="exampleInputText3">Alterno</label>
